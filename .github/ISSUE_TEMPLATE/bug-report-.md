---
name: Bug Report
about: Report a bug found in Ganvo Music to help us improve the application
...
```
**How to capture logs:**
- Use `adb logcat | grep -i ganvomusic` for filtered logs
...
- [ ] I have tested on the latest version of Ganvo Music
