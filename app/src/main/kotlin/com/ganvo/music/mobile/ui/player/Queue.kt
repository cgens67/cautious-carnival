...
import com.ganvo.music.mobile.constants.QueueEditLockKey
...
import com.ganvo.music.mobile.extensions.toggleRepeatMode
...
import com.ganvo.music.mobile.ui.component.MediaMetadataListItem
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.ganvo.music.mobile.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.ganvo.music.mobile.together.TogetherSessionState.Joined).role is com.ganvo.music.mobile.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.ganvo.music.mobile.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.ganvo.music.mobile.together.TogetherRole.Guest
                                                                if (isGuest) {
