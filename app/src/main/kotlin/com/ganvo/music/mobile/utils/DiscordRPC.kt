...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/ganvo/OpenTune/refs/heads/master/assets/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/ganvo/OpenTune"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.ganvo.music.mobile.utils.GlobalLog.append(
