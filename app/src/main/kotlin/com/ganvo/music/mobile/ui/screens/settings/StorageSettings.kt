...
import com.ganvo.music.mobile.constants.MaxImageCacheSizeKey
...
import com.ganvo.music.mobile.extensions.tryOrNull
import com.ganvo.music.mobile.ui.component.ActionPromptDialog
...
import com.ganvo.music.mobile.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.ganvo.music.mobile.utils.ArtworkStorage.clear(context)
            }
        }
    }
