...
-keep class com.ganvo.music.mobile.models.PersistQueue { *; }
-keep class com.ganvo.music.mobile.models.PersistPlayerState { *; }
-keep class com.ganvo.music.mobile.models.QueueData { *; }
-keep class com.ganvo.music.mobile.models.QueueType { *; }
-keep class com.ganvo.music.mobile.playback.queues.** { *; }
